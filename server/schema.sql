...
CREATE TABLE `core_ledger` (
  ...
  PRIMARY KEY (`id`),
  KEY `core_ledger_user_id_1ee84512_fk_core_user_id` (`user_id`),
  CONSTRAINT `core_ledger_user_id_1ee84512_fk_core_user_id` FOREIGN KEY (`user_id`) REFERENCES `core_user` (`id`)
...
-- Dump completed on 2023-02-23 20:10:58
